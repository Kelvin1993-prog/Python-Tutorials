...
#Two list will be shown below
content_ratings = ['4+', '9+', '12+', '17+']
numbers = [4433, 987, 1155, 622]

#Gentlemen, now comes the list of lists
...
percentage_14_allowed = content_ratings['4+']
...
for row in apps_data[1:]:
    ...
    n_user_ratings.append(data_size)
ratings_min = min(n_user_ratings)
ratings_max = max(n_user_ratings)

data_sizes =  {'0 - 20 MB': 0, '20 - 80 MB': 0, '80 - 200 MB': 0,
                     '200 - 500 MB': 0, '500 MB +': 0}

for row in apps_data[1:]:
    data_size = float(row[5])
    
    if data_size <= 10000:
        data_sizes['0 - 20 MB'] += 1
        
    elif 10000 < data_size <= 100000:
        data_sizes['20 - 80 MB'] += 1
        
    elif 100000 < data_size<= 500000:
        data_sizes['80 - 200 MB'] += 1
        
    elif 500000 < data_size <= 1000000:
        data_sizes['200 - 500 MB'] += 1
